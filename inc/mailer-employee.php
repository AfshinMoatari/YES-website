<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $email_content_company .= "<p>My name is " . "<b>" . $name . "</b>" . "," . "and I am " . "<b>" .  $age . "</b>" . " years old"  . "." . " I am interested in working " . "<b>" . $hours . "</b>" . " hours per month, and I have previous experience with " . "<b>" . $experience . "</b>" . " ." . " You can contact me on " . "<b>" . $email . "</b>" . " so that we can talk about my desire to work at YESCPH.</p>";
